...
export class EngravingRules {
    ...
    public loadDefaultValues(): void {
        ...
        // xSpacing Variables
        this.VoiceSpacingMultiplierVexflow = 0.82;
        this.VoiceSpacingAddendVexflow = 2.8;
        ...
        this.SoftmaxFactorVexFlow = 15; // Vexflow 5 default is 10. Slightly higher for better grace note spacing.
