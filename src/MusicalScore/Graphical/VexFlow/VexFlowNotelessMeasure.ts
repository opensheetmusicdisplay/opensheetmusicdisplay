...
/** A GraphicalMeasure drawing a noteless measure in Vexflow, e.g. a multiple rest measure or simile measure.
 *  Mostly copied from VexFlowMeasure. (this used to be VexFlowMultiRestMeasure before being generalized)
 *  Even though most of those functions aren't needed, apparently you can't remove the layoutStaffEntry function.
 */
export class VexFlowNotelessMeasure extends VexFlowMeasure {
