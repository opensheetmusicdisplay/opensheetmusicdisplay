...
export class Cursor {
    ...
    /**
     * get key value at current cursor
        ...
        for (let i: number = 0; i < this.iterator.CurrentVoiceEntries.length; i++) {
            for (let j: number = 0; j < this.iterator.CurrentVoiceEntries[i].Notes.length; j++) {
                if (this.iterator.CurrentVoiceEntries[i].Notes[j].Pitch) {
                    console.log(this.iterator.CurrentVoiceEntries[i].Notes[j]);
                    //if (this.iterator.CurrentVoiceEntries[i].Notes[j].Pitch.Octave === 0) {
                    arr.push((this.iterator.CurrentVoiceEntries[i].Notes[j].Pitch.getHalfTone()) + 12);
                    //} else {
